...
function tryParseIn(input) {
    ...
    const values = rawItems.map(parseLiteralValue);
    return {
        type: 'comparison',
        operator: 'IN',
        field,
...
function tryParseBetween(input) {
...
function parseLiteralValue(text) {
