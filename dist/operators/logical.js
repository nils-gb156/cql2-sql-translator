...
exports.parseLogical = parseLogical;
...
function parseLogical(input) {
    ...
    if (/\bBETWEEN\b/i.test(withoutOuter)) {
        const comparison = (0, comparison_1.parseComparison)(withoutOuter);
        if (comparison) {
            return comparison;
        }
    }
...
function parseLogicalOrComparison(text) {
    const comparison = (0, comparison_1.parseComparison)(text);
    if (comparison)
        return comparison;
